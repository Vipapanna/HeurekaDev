<template>
  ...
  <section class="w-full overflow-auto">
    <div class="flex whitespace-nowrap overflow-auto scrollbar-hide" ref="container">
      ...
      <button class="px-4 py-2 h-10 w-10 bg-gray-200 text-gray-700 font-semibold rounded-full mt-4" @click="scroll(-500)">Scroll Left</button>
      <button class="px-4 py-2 h-10 w-10 bg-gray-200 text-gray-700 font-semibold rounded-full mt-4" @click="scroll(500)">Scroll Right</button>
    </section>
